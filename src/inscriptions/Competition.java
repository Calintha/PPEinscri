...
/**
 * Représente une compétition, c'est-à-dire un ensemble de candidats inscrits à
 * un événement, les inscriptions sont closes à la date dateCloture.
 *
 */
...
public class Competition implements Comparable<Competition>, Serializable {
	...
	public boolean inscriptionsOuvertes() {
		// TODO retourner vrai si et seulement si la date systeme est anterieure a la
		// date de cloture.
		if (dateCloture != null) {
			...
			if (annee == dateCloture.getYear() && mois > dateCloture.getMonthValue()
					&& jour > dateCloture.getDayOfMonth()) {
				return false;
			}
		}
		return true;
	...
	/**
	 * Inscrit un candidat de type Personne à la compétition. Provoque une exception
	 * si la compétition est réservée aux équipes ou que les inscriptions sont
	 * closes.
	 * 
	 * @param personne
	 * @return

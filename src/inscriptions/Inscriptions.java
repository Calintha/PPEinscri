...
/**
 * Point d'entree dans l'application, un seul objet de type Inscription permet
 * de gerer les competitions, candidats (de type equipe ou personne) ainsi que
 * d'inscrire des candidats a des competitions.
 */
...
public class Inscriptions implements Serializable {
	...
	/**
	 * Cree une competition. Ceci est le seul moyen, il n'y a pas de constructeur
	...
	/**
	 * Cree une Candidat de type Personne. Ceci est le seul moyen, il n'y a pas de
	...
	/**
	 * Cree une Candidat de type equipe. Ceci est le seul moyen, il n'y a pas de
	...
	/**
	 * Retourne l'unique instance de cette classe. Cree cet objet s'il n'existe
	 * deja .
	 * 
	...
	/**
	 * Retourne un object inscriptions vide. Ne modifie pas les competitions et
	 * candidats deja  existants.
	 */
	...
	/**
	 * Efface toutes les modifications sur Inscriptions depuis la derniere
	 * sauvegarde. Ne modifie pas les competitions et candidats deja  existants.
	 */
	 ...
	 * execution ulterieure du programme.
	 * 
	 * @throws IOException
	 */
